...
def set_user():
    ...
    return {
        'insert': insert, 'select_all': select_all,
        'read': read, 'select': select,
        'update': update, 'delete': delete
    }

user_service = set_user()
user_service.get('insert')(title='테스트 제목6', content='테스트 내용6', file='/usr/post/file/img006.png')
print(user_service.get('select_all')())
print(user_service.get('read')(6))
print(user_service.get('read')(6))
print(user_service.get('select')(5))
